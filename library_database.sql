-- SQL Library Management Project for Data Analysis by Sarthak Jadhav.
...
-- 3. Employee table
INSERT INTO employee(emp_id, ename, position, salary, branch_id) 
VALUES
...
INSERT INTO issue_status(issued_id, issued_member_id, issued_book_title, issued_date, issued_book_isbn, issued_emp_id) 
VALUES
...
INSERT INTO return_status(return_id, issued_id, return_book_title, return_date, return_book_isbn)
VALUES
